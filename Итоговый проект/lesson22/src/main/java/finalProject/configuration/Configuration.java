...
import finalProject.browser.DriverType;
...
public class Configuration {
    ...
    public static void readProperties() {
        ...
        try {
            properties.load(new FileReader(new File(RESOURCES_PATH, "mainUrl.properties")));
    ...
    public static boolean getHeadlessOption() {
        if (properties == null) {
            readProperties();
        }
